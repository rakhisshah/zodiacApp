var zodiacs=[
{
	...
	description: "As the first sign in the zodiac, the presence of Aries always marks the beginning of something energetic and turbulent. ... Thanks to its ruling planet Mars and the fact it belongs to the element of Fire (just like Leo and Sagittarius), Aries is one of the most active zodiac signs."
},
{
	name: "Taurus",
	month: "April 21-May 20",
	description: "Taurus is an earth sign represented by the bull. ... Taurus is ruled by Venus, the enchanting planet that governs love, beauty, and money. Taurus's Venusian influence make this earth sign the most sensual of the zodiac: These cosmic oxen are enchanted by any physical manifestation of comfort and luxury."
},
{
	name: "Gemini",
	month: "May 21-June 20",
	description: "While most signs have one very prominent trait (for example, Capricorns are notoriously ambitious), Geminis, those born between May 21 and June 21, can be social, talkative, and whimsical, but they can also be indecisive or nosy. Some Geminis love to be the center of attention; others love to gossip."
},
{
	name: "Cancer",
...
},
{
	...
	description: "Scorpio is one of the most misunderstood signs of the zodiac. ... In fact, Scorpio is a water sign that derives its strength from the psychic, emotional realm. Like its fellow water signs, Cancer and Pisces, Scorpio is extremely clairvoyant and intuitive."
},
{
	name: "Sagittarius",
...
{
	name: "Aquarius",
	month: "January 22- February 22",
	description: "If you're friends with an Aquarius or Pisces, you're already familiar with their most prominent quality. They are very compassionate and calm. They don't let their emotions rule them. ... Being born between Aquarius and Pisces implies dealing with so many mixed feelings."
},
{
	name: "Pisces",
	month: "February 23- March 21",
